    ...
    return (
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-blue-600 flex-col justify-between p-12 relative overflow-hidden">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-blue-500 rounded-full opacity-20" />
                ...
                <div className="relative space-y-8">
                    ...
                    <div className="space-y-3">
                        {[
                            { icon: "🤳", title: "Selfie-powered search", desc: "Guests find their photos instantly" },
                            { icon: "😊", title: "Emotion filter gallery", desc: "Filter by happy, candid, surprised" },
                            { icon: "⏳", title: "Memory time capsule", desc: "Lock photos until a future date" },
                        ].map((f) => (
                            <div
                                key={f.title}
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        {[
                            ...
                            <div key={s.val} className="bg-white/10 border border-white/20 rounded-xl p-3 text-center">
                ...
                <div className="relative">
                    <p className="text-blue-100 text-sm italic leading-relaxed">
                        "Upload once. Let AI find every guest in seconds."
                    </p>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 py-12 sm:px-12 lg:px-16 bg-white">
                ...
                <div className="max-w-md w-full mx-auto">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-slate-500 text-sm">Sign in to manage your events and photos.</p>
                    </div>
